...
def get_action_from_frame(dia_state, courses):
    # TODO filter courses according to dia_state
    ...
    if len(courses) == 1: # find the unique course
        ...
        inform_slots = {}
        for slot in dia_state["request_slots"] + ["serial_no"]:# must provide serial_no to complete the task
...
# some fake courses
courses = [{"serial_no":"0001", "title":"機器學習技法", "instructor":"林軒田", "classroom":"資102", "schedule_str":"二5,6"}, {"serial_no":"0002", "title":"機器學習技法", "instructor":"張軒田", "classroom":"資102", "schedule_str":"二5,6"}, {"serial_no":"0003", "title":"機器學習技法", "instructor":"林軒田", "classroom":"資103", "schedule_str":"二5,6"}, {"serial_no":"0004", "title":"機器學習技法", "instructor":"林軒田", "classroom":"資102", "schedule_str":"二7,8"}]
#courses = Course.objects.filter(semester='105-2')

test_dia_states = []
# 1. 1 request 1 inform
dia_state = {}
dia_state["request_slots"] = {"title":"?"}
dia_state["inform_slots"] = {"schedule_str":"二7,8"}
...
for dia_state in test_dia_states:
    ...
    sys_act = get_action_from_frame(dia_state, courses)

    print ("== System Action ==")
    print (sys_act)
    NL = get_NL_from_action(sys_act)

    print ("== Template-based NLG ==")
    print (NL)
